...
def build_readme_values(code, languages, changelogs):
    ...
    content["placeholder_usage_path_note"] = content["p_usage_path_note"]
    content["placeholder_stream_kinds_note"] = content["p_stream_kinds_note"]
    content["placeholder_snapshot_options"] = bullet_list(content["snapshot_options"])

...
- `إصلاح` يجمع الإصدار ناتج البناء الحالي ويتحقق من الإصدارات والتوقيعات لمنع إعادة تسمية APK قديم كإصدار جديد
- `إصلاح` استخدام تواريخ بناء باللغة الإنجليزية في بيانات المكون بغض النظر عن لغة جهاز البناء
